...
public class AddTourAdapter extends RecyclerView.Adapter<AddTourAdapter.AddTourViewHolder> {

    private static final String TAG = "AddTourAdapter";
    private final List<Tour> toursDataSet;
    private final Context context;

    public static class AddTourViewHolder extends RecyclerView.ViewHolder {

        public TextView tourName;
        public ImageView coverImage;
        public TextView location;

        public AddTourViewHolder(View view) {
            super(view);
     ...
     * Empty constructor
     */
    public AddTourAdapter(Context context) {
    ...
    @NonNull
    @Override
    public AddTourViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_tour, parent, false);
        return new AddTourViewHolder(view);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    @Override
    public void onBindViewHolder(@NonNull AddTourViewHolder holder, int position) {

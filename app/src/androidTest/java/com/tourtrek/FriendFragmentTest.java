...
public class FriendFragmentTest {
    ...
    public void addFriendWithNullEmail() throws InterruptedException {
        ...
        onView(isRoot()).perform(waitForView(R.id.add_friend_error_tv, TimeUnit.SECONDS.toMillis(1000)));
    ...
    public void addFriendAlreadyExisted() throws InterruptedException {
        ...
        onView(withId(R.id.add_friend_search_btn)).perform(click());
        onView(isRoot()).perform(waitForView(R.id.add_friend_add_btn, TimeUnit.SECONDS.toMillis(1000)));
    ...
    public void removeAdded(){
        ...
        onView(isRoot()).perform(waitForView(R.id.friend_delete_btn, TimeUnit.SECONDS.toMillis(1000)));

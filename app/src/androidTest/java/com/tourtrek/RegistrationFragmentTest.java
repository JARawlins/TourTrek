...
public class RegistrationFragmentTest {
    ...
    public void RegisterWithNoUsername() throws InterruptedException {
        ...
        onView(withId(R.id.register_email_et)).perform(scrollTo(), typeText("fakeEmail@fake.com"));
        onView(withId(R.id.register_email_et)).perform(scrollTo(), typeText("fakeEmail@fake.com"));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.register_password1_et)).perform(scrollTo(), typeText("password"));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.register_password2_et)).perform(scrollTo(), typeText("password"));
        Espresso.closeSoftKeyboard();
    ...
    public void RegisterWithNoEmail() {
        onView(withId(R.id.register_username_et)).perform(scrollTo(), typeText("FakeUsername"));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.register_email_et)).perform(scrollTo(), typeText(""));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.register_password1_et)).perform(scrollTo(), typeText("password"));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.register_password2_et)).perform(scrollTo(), typeText("password"));
    ...
    public void RegisterWithWrongEmail1() throws InterruptedException {
        onView(withId(R.id.register_username_et)).perform(scrollTo(), typeText("FakeUsername"));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.register_email_et)).perform(scrollTo(), typeText("test123"));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.register_password1_et)).perform(scrollTo(), typeText("password"));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.register_password2_et)).perform(scrollTo(), typeText("password"));
    ...
    public void RegisterWithWrongEmail2() throws InterruptedException {
        onView(withId(R.id.register_username_et)).perform(scrollTo(), typeText("FakeUsername"));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.register_email_et)).perform(scrollTo(), typeText("@hello.com"));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.register_password1_et)).perform(scrollTo(), typeText("password"));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.register_password2_et)).perform(scrollTo(), typeText("password"));
    ...
    public void RegisterWithNoPassword() throws InterruptedException {
        ...
        onView(withId(R.id.register_email_et)).perform(scrollTo(), typeText("fakeEmail@fake.com"));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.register_password1_et)).perform(scrollTo(), typeText(""));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.register_password2_et)).perform(scrollTo(), typeText("password"));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.register_register_btn)).perform(scrollTo(), click());
    ...
    public void RegisterWithNoPassword2() throws InterruptedException {
        ...
        onView(withId(R.id.register_password1_et)).perform(scrollTo(), typeText("password"));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.register_password2_et)).perform(scrollTo(), typeText(""));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.register_register_btn)).perform(scrollTo(), click());
        Thread.sleep(1000);
        onView(withId(R.id.register_error_tv)).check(matches(withText("Not all fields entered")));
    ...
    public void RegisterWithShortPasswords() throws InterruptedException {
        ...
        onView(withId(R.id.register_email_et)).perform(scrollTo(), typeText("fakeEmail@fake.com"));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.register_password1_et)).perform(scrollTo(), typeText("hey"));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.register_password2_et)).perform(scrollTo(), typeText("hey"));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.register_register_btn)).perform(scrollTo(), click());
        Thread.sleep(1000);
